...
Häufig benutze Funktionen - wie zum Beispiel das Berechnen von Insulinabbau über Zeit im Blutkreislauf - welche in verschiedenen Algorithmen benötigt werden, werden ausgelagert in eigene Klassen. Dies ermöglicht es viele Funktionen in verschiedenen Algorithmen wieder zu verwenden und diese unabhängig von Algorithmen zu testen.
