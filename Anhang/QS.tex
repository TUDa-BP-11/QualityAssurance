...
In diesem Beispiel gibt funktion getRawBasalTreatments() null zurück und löst damit eine NullPointerException aus, da sie sehr kurz vor einem Scan erstellt wurde ist es keinem von uns vorher aufgefallen. 
Bild einfügen!!!
