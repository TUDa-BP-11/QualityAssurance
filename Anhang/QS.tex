...
\paragraph{31.03.3019 PR\#57}
\begin{itemize}
\item Protokoll: Bild~\ref{pr:57}
\item Manuelle Tests: Bild~\ref{pr-tests:56}
\item Plot 1: Bild~\ref{pr-plot:57-1}
\item Plot 2: Bild~\ref{pr-plot:57-2}
\item Plot 3: Bild~\ref{pr-plot:57-3}
\end{itemize}

\paragraph{31.03.3019 PR\#58}
\begin{itemize}
\item Protokoll: Bild~\ref{pr:58}
\item Manuelle Tests: Bild~\ref{pr-tests:56}
\end{itemize}
...
\begin{figure}[h]
\centering
\caption{Pull Request \#57}
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{pr-57}
\label{pr:57}
\end{figure}

\begin{figure}[h]
\centering
\caption{Plot Test 1 \#57}
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{Figure_1}
\label{pr-plot:57-1}
\end{figure}

\begin{figure}[h]
\centering
\caption{Plot Test 2 \#57}
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{Figure_2}
\label{pr-plot:57-2}
\end{figure}

\begin{figure}[h]
\centering
\caption{Plot Test 3 \#57}
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{Figure_3}
\label{pr-plot:57-3}
\end{figure}

\begin{figure}[h]
\centering
\caption{Pull Request \#58}
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{pr-58}
\label{pr:58}
\end{figure}
...
Beispielhafte Testergebnisse: \ref{pr-plot:57-1}, \ref{pr-plot:57-2}, \ref{pr-plot:57-3}
